...
class OpenClLoader
{
	...
	std::vector<cl_mem> allocatedMmemoryemroy;
  ...
  public:
	...
	cl_kernel load_kernel(char *filename, cl_device_id deviceId)
	{
		char *source_str;
		size_t source_size;
		FILE *fp;
		...
		re t= clSetKernelArg(kernel, 0, sizeof(cl_mem), (void *)&allocatedMemroy);
